...
public class FlagsDecorator extends AbstractDecorator {
  
  public FlagsDecorator(IDecoratable wrappee) {
  ...
  public ArrayList<JLabel> getImages() {
    try {
      Image resizedImage;
      image = ImageIO.read(new File(HouseImage.FlagsDecorator.getImageUrl()));
      int imageHeight = 300;
