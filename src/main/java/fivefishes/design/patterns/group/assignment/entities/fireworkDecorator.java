...
public class fireworkDecorator extends abstractDecorator {
  public fireworkDecorator(IDecoratable wrappee) {
  ...
  public ArrayList<JLabel> getImages() {
    try {
      Image resizedImage;
      image = ImageIO.read(new File(StaticResources.FireworkDecorator.label));
      int imageHeight = 300;
